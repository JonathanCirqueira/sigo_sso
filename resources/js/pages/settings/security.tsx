                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                Você será solicitado a fornecer um código de segurança
                                durante o login, que você pode obter no aplicativo de
                                suporte TOTP no seu telefone.
                            </p>
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                ...
                                solicitado a fornecer um código seguro durante o login.
                                Este código pode ser obtido em um aplicativo com
                                suporte TOTP no seu telefone.
                            </p>
